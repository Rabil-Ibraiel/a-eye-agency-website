...
export function SiteFooter() {
  return (
    <footer className="border-t border-white/12 bg-[#0b0c0c] text-[#f2eee5]">
      <div className="shell section-space pb-8">
        <div className="editorial-grid gap-y-12">
          ...
          <div className="col-span-full sm:col-span-4 lg:col-span-3 lg:col-start-7">
            <p className="mb-4 font-mono text-[0.65rem] tracking-[0.16em] text-[#f2eee5]/48 uppercase">
              Explore
            </p>
            <ul className="flex flex-col gap-1">
              {footerLinks.map((item) => (
                <li key={item.href}>
                  <Link className="inline-flex min-h-11 items-center text-sm text-[#f2eee5]/74 transition-colors hover:text-[#f2eee5]" href={item.href}>
                    {item.label}
                  </Link>
                </li>
              ))}
          ...
          <div className="col-span-full sm:col-span-4 lg:col-span-3 lg:col-start-10">
            ...
            <p className="max-w-52 text-sm leading-6 text-[#f2eee5]/74">
        ...
        <div className="mt-14 flex flex-col gap-4 border-t border-white/12 pt-6 font-mono text-[0.625rem] tracking-[0.13em] text-[#f2eee5]/42 uppercase sm:mt-16 sm:flex-row sm:items-center sm:justify-between">
